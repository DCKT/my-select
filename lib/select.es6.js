...
export default class Select {
  ...
  constructor(params) {
    this.selects  = document.querySelectorAll(params && params.select ? params.select : '.js-mySelect');
    this.wrappers = document.querySelectorAll('.js-mySelect-Wrapper');
    this.lists    = [];
    this.events   = [];
    this.nativeOnDevice = params && typeof params.nativeOnDevice != 'undefined' ? params.nativeOnDevice : true;
